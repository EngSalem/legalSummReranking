...
for fold in [1, 2, 3, 4, 5]:
    ...
    df_irc_led_fold = pd.read_csv(f'../../src/summarization/outputs/test_set_pred_argLEDAug_irc_tags_beam4_fold{fold}.csv')
    df_binary_led_fold = pd.read_csv(f'../../src/summarization/outputs/test_set_pred_argLEDAug_binary_beam4_fold{fold}.csv')
    ...
    df_test_full.to_csv(f'../../src/summarization/outputs/test_pred_combined_model_{rank_criteria}_voted{fold}.csv', index=False)
